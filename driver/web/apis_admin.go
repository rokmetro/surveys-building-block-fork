...
func (h AdminAPIsHandler) migrateScoreExternalUserIDs(l *logs.Log, r *http.Request, claims *tokenauth.Claims) logs.HTTPResponse {
	// Get batch size from query parameter (optional, defaults to DefaultExternalUserIDMigrationBatchSize)
	batchSize := core.DefaultExternalUserIDMigrationBatchSize
