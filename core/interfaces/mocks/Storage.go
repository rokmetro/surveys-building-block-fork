...
func (_m *Storage) CreateScore(score model.Score) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(model.Score) error); ok {
		r0 = rf(score)
	} else {
		r0 = ret.Error(0)
	}
...
// FindLowestHigherLeaderboardEntryScore provides a mock function with given fields: leaderboardID, orgID, appID, score
func (_m *Storage) FindLowestHigherLeaderboardEntryScore(leaderboardID string, orgID string, appID string, score float64) (*model.LeaderboardEntry, error) {
	ret := _m.Called(leaderboardID, orgID, appID, score)

	if len(ret) == 0 {
		panic("no return value specified for FindLowestHigherLeaderboardEntryScore")
	}

	var r0 *model.LeaderboardEntry
	var r1 error
	if rf, ok := ret.Get(0).(func(string, string, string, float64) (*model.LeaderboardEntry, error)); ok {
		return rf(leaderboardID, orgID, appID, score)
	}
	if rf, ok := ret.Get(0).(func(string, string, string, float64) *model.LeaderboardEntry); ok {
		r0 = rf(leaderboardID, orgID, appID, score)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(string, string, string, float64) error); ok {
		r1 = rf(leaderboardID, orgID, appID, score)
	} else {
		r1 = ret.Error(1)
	}
...
// FindLowestHigherScore provides a mock function with given fields: orgID, appID, score
func (_m *Storage) FindLowestHigherScore(orgID string, appID string, score float64) (*model.Score, error) {
	ret := _m.Called(orgID, appID, score)

	if len(ret) == 0 {
		panic("no return value specified for FindLowestHigherScore")
	}

	var r0 *model.Score
	var r1 error
	if rf, ok := ret.Get(0).(func(string, string, float64) (*model.Score, error)); ok {
		return rf(orgID, appID, score)
	}
	if rf, ok := ret.Get(0).(func(string, string, float64) *model.Score); ok {
		r0 = rf(orgID, appID, score)
	} else {
		if ret.Get(0) != nil {
...
// GetLeaderboardEntries provides a mock function with given fields: orgID, appID, leaderboardID, userID
func (_m *Storage) GetLeaderboardEntries(orgID string, appID string, leaderboardID *string, userID *string) ([]model.LeaderboardEntry, error) {
	ret := _m.Called(orgID, appID, leaderboardID, userID)
	...
	if rf, ok := ret.Get(0).(func(string, string, *string, *string) ([]model.LeaderboardEntry, error)); ok {
		return rf(orgID, appID, leaderboardID, userID)
	}
	if rf, ok := ret.Get(0).(func(string, string, *string, *string) []model.LeaderboardEntry); ok {
		r0 = rf(orgID, appID, leaderboardID, userID)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]model.LeaderboardEntry)
		}
	...
	if rf, ok := ret.Get(1).(func(string, string, *string, *string) error); ok {
		r1 = rf(orgID, appID, leaderboardID, userID)
	} else {
		r1 = ret.Error(1)
	}
...
// GetLeaderboardScores provides a mock function with given fields: leaderboardID, orgID, appID, limit, offset
func (_m *Storage) GetLeaderboardScores(leaderboardID string, orgID string, appID string, limit *int, offset *int) ([]model.Score, error) {
	ret := _m.Called(leaderboardID, orgID, appID, limit, offset)
	...
	if rf, ok := ret.Get(0).(func(string, string, string, *int, *int) ([]model.Score, error)); ok {
		return rf(leaderboardID, orgID, appID, limit, offset)
	}
	if rf, ok := ret.Get(0).(func(string, string, string, *int, *int) []model.Score); ok {
		r0 = rf(leaderboardID, orgID, appID, limit, offset)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]model.Score)
		}
	...
	if rf, ok := ret.Get(1).(func(string, string, string, *int, *int) error); ok {
		r1 = rf(leaderboardID, orgID, appID, limit, offset)
	} else {
		r1 = ret.Error(1)
	}
...
// GetLeaderboardWithUserContext provides a mock function with given fields: leaderboardID, orgID, appID, userID
func (_m *Storage) GetLeaderboardWithUserContext(leaderboardID string, orgID string, appID string, userID string) (*model.Leaderboard, error) {
	ret := _m.Called(leaderboardID, orgID, appID, userID)
...
// GetSurveysWithResponses provides a mock function with given fields: orgID, appID, userID, creatorID, surveyIDs, surveyTypes, calendarEventID, limit, offset, timeFilter, public, archived, completed, includeResponses, sortByDateCreated, unstructuredProperties, query
func (_m *Storage) GetSurveysWithResponses(orgID string, appID string, userID *string, creatorID *string, surveyIDs []string, surveyTypes []string, calendarEventID string, limit *int, offset *int, timeFilter *model.SurveyTimeFilter, public *bool, archived *bool, completed *bool, includeResponses *bool, sortByDateCreated *bool, unstructuredProperties map[string]interface{}, query *string) ([]model.Survey, error) {
	ret := _m.Called(orgID, appID, userID, creatorID, surveyIDs, surveyTypes, calendarEventID, limit, offset, timeFilter, public, archived, completed, includeResponses, sortByDateCreated, unstructuredProperties, query)
	...
	var r0 []model.Survey
	var r1 error
	if rf, ok := ret.Get(0).(func(string, string, *string, *string, []string, []string, string, *int, *int, *model.SurveyTimeFilter, *bool, *bool, *bool, *bool, *bool, map[string]interface{}, *string) ([]model.Survey, error)); ok {
		return rf(orgID, appID, userID, creatorID, surveyIDs, surveyTypes, calendarEventID, limit, offset, timeFilter, public, archived, completed, includeResponses, sortByDateCreated, unstructuredProperties, query)
	}
	if rf, ok := ret.Get(0).(func(string, string, *string, *string, []string, []string, string, *int, *int, *model.SurveyTimeFilter, *bool, *bool, *bool, *bool, *bool, map[string]interface{}, *string) []model.Survey); ok {
		r0 = rf(orgID, appID, userID, creatorID, surveyIDs, surveyTypes, calendarEventID, limit, offset, timeFilter, public, archived, completed, includeResponses, sortByDateCreated, unstructuredProperties, query)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]model.Survey)
		}
	...
	if rf, ok := ret.Get(1).(func(string, string, *string, *string, []string, []string, string, *int, *int, *model.SurveyTimeFilter, *bool, *bool, *bool, *bool, *bool, map[string]interface{}, *string) error); ok {
		r1 = rf(orgID, appID, userID, creatorID, surveyIDs, surveyTypes, calendarEventID, limit, offset, timeFilter, public, archived, completed, includeResponses, sortByDateCreated, unstructuredProperties, query)
	} else {
		r1 = ret.Error(1)
	}
...
// UpdateLeaderboardEntryRanks provides a mock function with given fields: leaderboardID, orgID, appID, score
func (_m *Storage) UpdateLeaderboardEntryRanks(leaderboardID string, orgID string, appID string, score float64) ([]model.LeaderboardEntry, error) {
	ret := _m.Called(leaderboardID, orgID, appID, score)

	if len(ret) == 0 {
		panic("no return value specified for UpdateLeaderboardEntryRanks")
	}
...
// UpdateScoreRanks provides a mock function with given fields: orgID, appID, score
func (_m *Storage) UpdateScoreRanks(orgID string, appID string, score float64) error {
	ret := _m.Called(orgID, appID, score)

	if len(ret) == 0 {
		panic("no return value specified for UpdateScoreRanks")
	}
...
// UpdateUserLeaderboardEntryRank provides a mock function with given fields: leaderboardID, orgID, appID, userID, rank
func (_m *Storage) UpdateUserLeaderboardEntryRank(leaderboardID string, orgID string, appID string, userID string, rank uint32) error {
	ret := _m.Called(leaderboardID, orgID, appID, userID, rank)

	if len(ret) == 0 {
		panic("no return value specified for UpdateUserLeaderboardEntryRank")
	}

	var r0 error
	if rf, ok := ret.Get(0).(func(string, string, string, string, uint32) error); ok {
		r0 = rf(leaderboardID, orgID, appID, userID, rank)
	} else {
		r0 = ret.Error(0)
	}
...
// UpdateUserScoreRank provides a mock function with given fields: orgID, appID, userID, rank
func (_m *Storage) UpdateUserScoreRank(orgID string, appID string, userID string, rank uint32) error {
	ret := _m.Called(orgID, appID, userID, rank)

	if len(ret) == 0 {
		panic("no return value specified for UpdateUserScoreRank")
	}

	var r0 error
	if rf, ok := ret.Get(0).(func(string, string, string, uint32) error); ok {
		r0 = rf(orgID, appID, userID, rank)
	} else {
		r0 = ret.Error(0)
	}
