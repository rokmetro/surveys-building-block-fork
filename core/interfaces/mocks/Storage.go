...
// GetSurveysWithResponses provides a mock function with given fields: orgID, appID, userID, creatorID, surveyIDs, surveyTypes, calendarEventID, limit, offset, timeFilter, public, archived, completed, includeResponses, sortByDateCreated, unstructuredProperties
func (_m *Storage) GetSurveysWithResponses(orgID string, appID string, userID *string, creatorID *string, surveyIDs []string, surveyTypes []string, calendarEventID string, limit *int, offset *int, timeFilter *model.SurveyTimeFilter, public *bool, archived *bool, completed *bool, includeResponses *bool, sortByDateCreated *bool, unstructuredProperties map[string]interface{}) ([]model.Survey, error) {
	ret := _m.Called(orgID, appID, userID, creatorID, surveyIDs, surveyTypes, calendarEventID, limit, offset, timeFilter, public, archived, completed, includeResponses, sortByDateCreated, unstructuredProperties)
	...
	var r0 []model.Survey
	var r1 error
	if rf, ok := ret.Get(0).(func(string, string, *string, *string, []string, []string, string, *int, *int, *model.SurveyTimeFilter, *bool, *bool, *bool, *bool, *bool, map[string]interface{}) ([]model.Survey, error)); ok {
		return rf(orgID, appID, userID, creatorID, surveyIDs, surveyTypes, calendarEventID, limit, offset, timeFilter, public, archived, completed, includeResponses, sortByDateCreated, unstructuredProperties)
	}
	if rf, ok := ret.Get(0).(func(string, string, *string, *string, []string, []string, string, *int, *int, *model.SurveyTimeFilter, *bool, *bool, *bool, *bool, *bool, map[string]interface{}) []model.Survey); ok {
		r0 = rf(orgID, appID, userID, creatorID, surveyIDs, surveyTypes, calendarEventID, limit, offset, timeFilter, public, archived, completed, includeResponses, sortByDateCreated, unstructuredProperties)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]model.Survey)
		}
	...
	if rf, ok := ret.Get(1).(func(string, string, *string, *string, []string, []string, string, *int, *int, *model.SurveyTimeFilter, *bool, *bool, *bool, *bool, *bool, map[string]interface{}) error); ok {
		r1 = rf(orgID, appID, userID, creatorID, surveyIDs, surveyTypes, calendarEventID, limit, offset, timeFilter, public, archived, completed, includeResponses, sortByDateCreated, unstructuredProperties)
	} else {
		r1 = ret.Error(1)
	}
