...
// InitLeaderboardScores initializes score values for all leaderboard entries in the specified org/app
func (a appAdmin) InitLeaderboardScores(orgID string, appID string) error {
