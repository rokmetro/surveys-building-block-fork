...
// FindScoresNoRanks provides a mock function with given fields: orgID, appID, userID, missingExternalUserID, limit, offset
func (_m *Storage) FindScoresNoRanks(orgID string, appID string, userID []string, missingExternalUserID bool, limit *int, offset *int) ([]model.Score, error) {
	ret := _m.Called(orgID, appID, userID, missingExternalUserID, limit, offset)
	...
	if rf, ok := ret.Get(0).(func(string, string, []string, bool, *int, *int) ([]model.Score, error)); ok {
		return rf(orgID, appID, userID, missingExternalUserID, limit, offset)
	}
	if rf, ok := ret.Get(0).(func(string, string, []string, bool, *int, *int) []model.Score); ok {
		r0 = rf(orgID, appID, userID, missingExternalUserID, limit, offset)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(string, string, []string, bool, *int, *int) error); ok {
		r1 = rf(orgID, appID, userID, missingExternalUserID, limit, offset)
	} else {
		r1 = ret.Error(1)
	}
...
// GetLeaderboardUserRanks provides a mock function with given fields: orgID, appID, userID, limit, offset
func (_m *Storage) GetLeaderboardUserRanks(orgID string, appID string, userID string, limit *int, offset *int) ([]model.Leaderboard, error) {
	...
	var r0 []model.Leaderboard
	var r1 error
	if rf, ok := ret.Get(0).(func(string, string, string, *int, *int) ([]model.Leaderboard, error)); ok {
		return rf(orgID, appID, userID, limit, offset)
	}
	if rf, ok := ret.Get(0).(func(string, string, string, *int, *int) []model.Leaderboard); ok {
...
// InitLeaderboardEntryScores provides a mock function with given fields: orgID, appID
func (_m *Storage) InitLeaderboardEntryScores(orgID string, appID string) error {
	ret := _m.Called(orgID, appID)
...
// UpdateScoreExternalUserID provides a mock function with given fields: scoreID, externalUserID
func (_m *Storage) UpdateScoreExternalUserID(scoreID string, externalUserID string) error {
	ret := _m.Called(scoreID, externalUserID)
