...
func (h AdminAPIsHandler) initRanks(l *logs.Log, r *http.Request, claims *tokenauth.Claims) logs.HTTPResponse {
	err := h.app.Admin.InitRanks(claims.OrgID, claims.AppID)
	if err != nil {
